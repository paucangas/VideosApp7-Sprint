    ...
    <div class="user-form-container">
        <div class="user-form-card">
            <div class="form-header">
                <h1 class="form-title">Afegir Nou Usuari</h1>
                <div class="form-icon">
            ...
            <form action="{{ route('users.manage.store') }}" method="POST" class="user-form">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="text" name="name" id="name" data-qa="input-name" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="email" name="email" id="email" data-qa="input-email" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <input type="password" name="password" id="password" data-qa="input-password" required>
                    </div>
                </div>
