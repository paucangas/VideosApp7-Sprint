<x-videos-app-layout>
    <div class="series-create-container">
        <div class="series-create-card">
            ...
            <form action="{{ route('series.store') }}" method="POST" enctype="multipart/form-data" data-qa="create-series-form" class="series-create-form">
                @csrf
                ...
                <button type="submit" class="btn-create-serie">
